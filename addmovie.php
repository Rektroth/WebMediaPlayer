<?php
	...
	if ($_SESSION["user_admin"])
	{
		...
		{
			$titleErr = $posterErr = $descriptionErr = $ratingErr = $genreErr = $runtimeErr = $releaseErr = $viewIDErr = "";
			...
			{
				$query = "INSERT INTO items (type) VALUES ('movie')";
				...
				$query = "INSERT INTO movies (id, title, description, rating, runtime, release_date, view_id) VALUES (?, ?, ?, ?, ?, ?, ?)";
				$success = $dbHandle->runQuery($query, "isssiss", array($itemID, $title, $description, $rating, $runtime, $release, $viewID));
				...
				{
					$titleErr = "An error occured in adding the new movie.";
				}
			}
		}
	}
...
<html lang="en">
	<head>
		...
		<title>Pirate Library - Add Movie</title>
	</head>
	<body>
		<header>
			<div class="top-nav">
		...
		<div class="item-wrapper">
			<h2>Add Movie</h2>
			<p>Enter the info for the movie you are adding.</p>
